            ...
            <div class="wrapper">
                <div class="card"> 
                    ...
                    <div class="price_button">
                        ...
                        <form class="book" action="" method="POST"><button name="book_helcow">BUY FOR 1 HOUR</button></form>
                    </div>
                    <div class="alert">
...
<script>
function initMap() {
    var helcow = { lat: 50.072331, lng: 19.937665};
    var opt = {
        center: { lat: 50.072331, lng: 19.937665},
                zoom: 17,
    };
